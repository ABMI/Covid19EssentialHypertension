...
2. In `R`, use the following `devtools` command to install the Covid19EssentialHypertension package:
...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
	...
	```r
	library(Covid19EssentialHypertension)
	...
	outputFolder <- "c:/Covid19EssentialHypertension"
...
License
=======
The Covid19EssentialHypertension package is licensed under Apache License 2.0

Development
===========
Covid19EssentialHypertension was developed in ATLAS and R Studio.
